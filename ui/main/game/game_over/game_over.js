...
$(document).ready(function () {
    ...
    function GameOverViewModel() {
        ...
        self.leaguePosition = ko.observable(-1);

        self.leagueText = ko.computed(function ()
        {
            var position = self.leaguePosition();
            ...
            return position + MatchmakingUtility.getTitle(self.league());
        });
        ...
        self.getPlayerRank = function (gameType)
        {
            ...
            api.Panel.query(api.Panel.parentId, 'panel.invoke', ['uberId']).then(function(uberId)
            {
                ...
                $.getJSON( 'https://api.planetaryannihilation.net/leaderboard/player?GameType=' + gameType + '&UserId=' + uberId, 'GET', 'json' ).done( function( data )
                {
                    ...
                    self.leaguePosition(data.LeaguePosition);
    ...
    handlers.rating_updated = function(payload) {
        ...
        model.getPlayerRank(MatchmakingUtility.getMatchmakingStatsType());
