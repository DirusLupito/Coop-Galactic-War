...
define(['shared/gw_common'], function(GW)
{
    return {
        ...
        {
            var chance = 0;
            if( inventory.hasCard('gwc_enable_vehicles_t1') || inventory.hasCard('gwc_enable_vehicles_all') || inventory.hasCard('gwc_start_vehicle') )
                chance = 60;
        ...
        buff: function(inventory, params)
        {
            ...
            [
                ...
                '/pa/units/land/attack_vehicle/attack_vehicle_ammo.json'
            ];
