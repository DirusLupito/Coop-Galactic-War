...
// clicked ignore on game invite notification
        ...
        self.viewReplays = function() {
            api.Panel.message('game', 'view_contact_replays', {uberId: self.uberId(), displayName: self.displayName()});
        }
    };
    ...
    function SocialViewModel() {
        ...
        self.userTagMap = ko.observable({ /* id: { tag ... tag } */ }).extend({ panet: 'user_tag_map' });
...
// search for uber name if not found
        ...
        {
            var displayName = self.newDisplayName();
